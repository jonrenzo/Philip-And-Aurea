									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['house_rented']; if ($titleRow) echo ' - ' . $titleRow['title']?></td>
                                                    ...
                                                    <td>
														...
														data-id2="<?php echo $row['house_rented'] ?>"
														>View</button>
														...
														\"$row[uphone]\", 
														$row[house_rented],
														\"$row[uimage]\")'" ?> class="btn btn-primary text-white">Edit</a>
														<a href="userdelete.php?id=<?php echo $row['uid']; ?>"><button class="btn btn-danger">Delete</button></a></td>
                                                </tr>
                                                <?php
												$cnt=$cnt+1;
												} 
