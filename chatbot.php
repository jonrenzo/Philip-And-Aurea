...
<div class="container">
    <div class="chatbox">
        ...
        <div class="chatbox__button">
            <button><img src="chatbot-deployment/static/images/chatbox-icon.svg" /></button>
        </div>
    </div>
</div>
