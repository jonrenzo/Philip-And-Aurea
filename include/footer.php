<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <h1>Philip and Aurea Residences</h1> </div>
                                        <p class="pb-20 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum obcaecati ratione sed? Quae distinctio facilis dicta fugiat eligendi nesciunt nam. Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, optio!</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>123 Alkalde, Kapasigan</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>0912341235123</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>091234123123123</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>cedric@gmail.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Philip and Aurea Residences - Developed By Group #</span> </div>
                    <div class="col-sm-6">
